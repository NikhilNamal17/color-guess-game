...
The Game has is all about picking the right colour from the randomly generated square's of colors. Try the demo by clicking the above link.
...
## The Easy Mode
The easy mode consists of only 3 squares of random colors to guess.
...
## The Hard Mode
The hard mode consists of 6 squares of random colors to guess. This is the default mode of play.
...
The super hard mode consists of total 9 squares of random colors to guess.
